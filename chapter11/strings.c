/* strings.c -- 使用字符串与用户进行交互，这个程序展示了许多有关字符串的操作 */
#include <stdio.h>
...
int main(void)
{
    ...
    int i;
    const char m1[40] = "Limit yourself to one line's worth. "; //初始化一个大小确定的char数组
    const char m2[] = "If you can't think of anything, fake it. "; //让编译器计算数组大小
    const char *m3 = "\nEnough about me - what's your name? ";
    const char *mytal[LIM] = {  //方括号和mytal先结合在一起，所以这里表示一个存有5个指针的数组
